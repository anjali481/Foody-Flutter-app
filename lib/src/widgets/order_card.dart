      ...
      child:Row(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image:DecorationImage(image:AssetImage("assests/lunch.jpg"),
            fit: BoxFit.cover,
            ),
        ...
        Column(
          ...
          children:<Widget>[
           Text(" Masala Dosa",style: TextStyle(fontSize :17.0,fontWeight:FontWeight.bold,),),
           SizedBox(
             height: 5.0,
           ),
           Text("3.0",style: TextStyle(color:Colors.blue,),),
            SizedBox(
             height: 5.0,
           ),
           ...
           Container(
             ...
             child: Row(
                ...
                Text("Dosa",style: TextStyle(color:Colors.grey,fontWeight:FontWeight.bold),),
                SizedBox(width:5.0,),
